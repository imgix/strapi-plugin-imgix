...
## Versions
- **Strapi v5** - [v2.x](https://github.com/imgix/strapi-plugin-imgix)
- **Strapi v4** - (current) [v1.x](https://github.com/imgix/strapi-plugin-imgix/tree/v4)
...
- Strapi v4.25.20 (recently tested)
- Strapi v4.x
